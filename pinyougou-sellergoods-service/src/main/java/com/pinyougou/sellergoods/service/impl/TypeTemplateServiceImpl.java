...
public class TypeTemplateServiceImpl implements TypeTemplateService {
    ...
    public void cacheRedis() {
        ...
        //缓存品牌
        list.stream().forEach(e -> redisTemplate.boundHashOps("brandList").put(e.getId(),
                JSON.parseArray(e.getBrandIds(), Map.class)));
        //缓存规格
        list.stream().forEach(e -> redisTemplate.boundHashOps("specList").put(e.getId(),
                findSpecList(e.getId())));
    }
}
